$(function(){
	...
	function ctor(){
        ...
        loadNotebookNav();
        loadEditProfile();
        global_page_progressBar();
	}
    function loadNotebookNav(){
        $(".global_page_notebookNav").load("www/pages/notebookNav/notebookNav.html", function() {
			notebookNav.ctor();
		});
    }
    ...
    function global_page_progressBar(){
        $(".global_page_progressBar").load("www/pages/progressBar/progressBar.html", function() {
			progressBar.ctor();
		});	
    }
	function loadRank(){
    ...
    function loadEditProfile(){
		$(".global_page_editProfile").load("www/pages/editProfile/editProfile.html", function() {
			editProfile.ctor();
		});	
	}
