...
function mentorJs(){
    ...
    function finishLevel9(){
		$(".mentor_box_holder_leve1").fadeOut();
		var text = "מאדאר פאקר עוז תמצא תוספת שאפשר לרשום על השלב הזה.";
		var bonus = 10;
    ...
    function finishLevel10(){
		$(".mentor_box_holder_leve1").fadeOut();
		var text = "מעולה, עוז תכניס טקסט למשהו 10.";
		var bonus = 50;
	...
	function finishLevel8(){
		$(".mentor_box_holder_leve1").fadeOut();
		var text = "עוז תן שורת הסבר על המפעל, שהוא לא מכניס כסף רק אחרי שיש לו מסעדה.";
		var bonus = 30;
