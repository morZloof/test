...
function headerJS (){
	function ctor(){
        ...
        $(".header_cont_logout").click(logOut);
        $(".header_cont_setting").click(showSetting);
        $(".header_setting_profile").click(showProfile);
        $(".header_setteing_password").click(setPassword);
	}
	this.ctor = ctor;
	...
	function showSetting() {
        $(".header_cont_setting_click").toggle();
    }

    function showProfile () {
        profile.showPage($.globalUser.id);
    }

    function setPassword() {

        editProfile.showPage($.globalUser.id);
    }
